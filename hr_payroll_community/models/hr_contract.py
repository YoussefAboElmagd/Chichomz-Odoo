...
class HrContract(models.Model):
    ...
    meal_allowance = fields.Monetary(string="Bonuses", help="Meal allowance")
    medical_allowance = fields.Monetary(string="Medical Allowance", help="Medical allowance")
    tdd = fields.Monetary(string="Tax Deduction Due", help="Tax Deduction Due")
    taosic = fields.Monetary(string="Total Amount Owed To Social Insurance Authority", help="Total Amount Owed To Social Insurance Authority")
    essi = fields.Monetary(string="The Employer's Share Of Social Insurance", help="The Employer's Share Of Social Insurance")
    wssi = fields.Monetary(string="The Worker’s Share Of Social Insurance", help="The Worker’s Share Of Social Insurance")
