...
class ShopifyInstanceEpt(models.Model):
    ...
    def connect_in_shopify(self, vals=False):
        ...
        shop_url = self.prepare_shopify_shop_url('decorat-store.myshopify.com', api_key, password)
    ...
    def refresh_webhooks(self):
        ...
        _logger.info("Webhooks Feeeeeeeeen %s" , shopify_webhook)
        responses = shopify_webhook.find()
        _logger.info("Emipro-Webhook: List Of Webhooks %s" , responses)
        webhook_ids = []
