...
class Users(models.Model):
    ...
    enable_idle = fields.Boolean(string="Enable Idle Timeout",
                                 help="Enable Idle Timer")
    idle_time = fields.Integer(string="Idle Time (In minutes)", default=10,
                               help="Set Idle Time For theis User")
    idle_time_out = fields.Integer(string="Idle Timeout (In minutes)", default=10,
                               help="Set Idle Timeout For theis User")
    is_on_break = fields.Boolean(string="On Break",
                                 default=False,
                                 help="Check if employee is on break")
    # SQL constraints
    _sql_constraints = [
